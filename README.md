...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fd28f4964f07b001564da5e
...
To start editing your site, you can use the Sanity interface at https://superb-kangaroo-28f49.sanity.studio/.
...
Generated at `2020-12-10T21:13:03.884Z` by Stackbit version `0.3.39`.